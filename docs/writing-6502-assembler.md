...
## Trying it out
I know that this assembler is not really anything that anyone want's to try out or mess with, but if you have any interest in it feel free to check it out. The C# project is [open source on GitHub](https://github.com/BrentFarris/Brents6502). I'll probably add more to the assembler as I need it, but the main goal was to (1) learn all about 6502 assembly and (2) create an Assembler that is bare bones and works with the syntax I know so far. Yes, yes, I know there are a ton of assemblers out there that I can just download and use (and I have) but that takes all the fun out of it.
