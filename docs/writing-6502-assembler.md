...
| <a name="ASL">ASL</a> |   | 0xA | N Z C | 2 | 0 | 0 |
| <a name="ASL">ASL</a> | A | 0xA | N Z C | 2 | 0 | 0 |
| <a name="ASL">ASL</a> | $F9 | 0x6 | N Z C | 5 | 0 | 0 |
| <a name="ASL">ASL</a> | $F9,X | 0x16 | N Z C | 6 | 0 | 0 |
| <a name="ASL">ASL</a> | $0200 | 0xE | N Z C | 6 | 0 | 0 |
