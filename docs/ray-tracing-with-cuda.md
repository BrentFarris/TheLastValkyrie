...
description: How I wrote a ray tracer that took over 5 minutes on CPU and remade it in CUDA to render in ~20 milliseconds
...
**What took the CPU (1 thread) over 5 minutes to render, I was able to get CUDA to render in ~20 milliseconds.**
